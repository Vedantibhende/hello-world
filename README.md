...
* [Name of the resources](https://link-to-the-resource.com/) -Vedanti bhende A brief description of why it's great.

Commit Your Changes: Scroll to the bottom of the page. In the "Commit changes"name box, write a short, clear message that describes your contribution. For example: Add The Odin Project to the list. Then, click the green Commit changes button.
